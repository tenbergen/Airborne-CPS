...
namespace textureconstants {
	...
	GlRgb8Color constexpr K_RECOMMENDATION_RANGE_POSITIVE_INVERTED = { 0.141f, 0.647f, 0.059f };
	GlRgb8Color constexpr K_RECOMMENDATION_RANGE_NEGATIVE_INVERTED = { 0.602f, 0.102f, 0.09f };
